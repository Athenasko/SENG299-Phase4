...
# Version: 1.0
# Description: This application is the implementation of a messaging system that implements chat rooms, aliases, and a GUI. This file is the server side and will require clients to connect.
	...
	while 1:
		...
		for sock in ready_for_reading:
			...
			if sock == server_socket:
				...
				#broadcast(server_socket, sock_forward, "[%s:%s] entered the room Greet them pleasantly!" % address)
			#message for already connected client
				...
				try:	
					...
					if message_data:
						...
						broadcast(server_socket, sock, message_data)
